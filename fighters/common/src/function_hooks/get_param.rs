...
pub unsafe fn get_param_float_hook(x0 /*boma*/: u64, x1 /*param_type*/: u64, x2 /*param_hash*/: u64) -> f32 {
    ...
    if fighter_kind == *FIGHTER_KIND_SAMUS {
        if VarModule::is_flag(boma_reference.object(), vars::samus::instance::SHINESPARK_READY) {
            ...
            if x1 == hash40("run_accel_add") {
                return ParamModule::get_float(boma_reference.object(), ParamType::Agent, "speedboost.run_accel_add");
            }
        ...
        && VarModule::is_flag(boma_reference.object(), vars::common::instance::SPECIAL_STALL_USED) {
            return 0.0;
        }
    }
    
    else if x1 == hash40("param_trenchmortarbullet") && x2 == hash40("speed_x") {
